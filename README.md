...
For pytorch to work with CUDA (cudatoolkit 10.2): `pip uninstall torch`, `conda install pytorch==1.9.1 torchvision==0.10.1 torchaudio==0.9.1 cudatoolkit=10.2 -c pytorch`.
